  ...
  return (
    <div>
      <div className="px-4 sm:px-0">
        <h3 className="text-base font-semibold leading-7 text-gray-900">Professional Experience</h3>
        <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Freelance Web Developer</p>
      </div>
      <div className="mt-6 border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-6 text-gray-900">Full name</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Mio Terasaki</dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-6 text-gray-900">Job Title / Occupation / Role</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Backend Developer</dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-6 text-gray-900">Email address</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">me512papiko512@gmail.com</dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-6 text-gray-900">Contact Section</dt>
            <dd className="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">
              <ul role="list">
                <li className="flex">
                  <a className="group flex text-sm font-medium text-gray-500 transition hover:text-teal-500" href="https://x.com/kbBoNj3eiRW4fvD">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none text-gray-700 transition group-hover:fill-teal-500">
                ...
                <li className="mt-4 flex">
                  <a className="group flex text-sm font-medium text-gray-500 transition hover:text-teal-500" href="https://github.com/Temmy3620">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none text-gray-700 transition group-hover:fill-teal-500">
                ...
                <li className="mt-4 flex">
                  <a className="group flex text-sm font-medium text-gray-500 transition hover:text-teal-500" href="#">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none text-gray-700 transition group-hover:fill-teal-500">
                ...
                <li className="mt-4 flex">
                  <a className="group flex text-sm font-medium text-gray-500 transition hover:text-teal-500" href="mailto:me512papiko512@gmail.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none text-gray-700 transition group-hover:fill-teal-500">
                    ...
                    <span className="ml-4">me512papiko512@gmail.com</span>
                  </a>
                </li>
              </ul>
            </dd>
