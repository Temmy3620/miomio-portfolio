    ...
    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
      ...
      <div className="lg:order-first lg:row-span-2">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
          I’m Mio Terasaki. I currently work as a Freelance Web Developer while traveling the world.
        </h1>
        <div className="mt-10 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
          <ul>
            <li><strong>Name</strong>: Mio Terasaki</li>
            <li><strong>Age</strong>: 25</li>
            <li><strong>Gender</strong>: Female</li>
            <li><strong>Origin</strong>: Japan</li>
            <li><strong>Current Location</strong>: Traveling the world while working remotely</li>
            <li><strong>Profession</strong>: Freelance Web Engineer</li>
          </ul>

          <ul>
            <li><strong>Backend Development</strong>: PHP, Laravel, API integrations (Microsoft Advertising, Google Ads)</li>
      ...
      <div className="lg:pl-20">
        <ul role="list">
          ...
          <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
            <a
              className="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
              href="mailto:me512papiko512@gmail.com"
            >
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
